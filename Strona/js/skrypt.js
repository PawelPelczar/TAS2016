...
function closeAnkieta(){ // Zastępuje ankietę tekstem podziękowania za uczestnictwo po jej zatwierdzeniu
  document.getElementById("main").innerHTML="<div class='container'><div class='row'><div class='twelwe columns content'>Ankieta została wysłana.<br>Dziękujemy!</div></div></div>";
}
